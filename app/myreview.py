...
def myreview():
    if request.method == 'POST':
        ...
        productreviews = ProductReview.get_user_reviews(user_id)
        # get all seller reviews from the user:
        sellerreviews = SellerReview.get_user_reviews(user_id)
        ...
        return render_template('myreviews.html', my_products_reviews = productreviews, my_seller_reviews = sellerreviews, my_top5_reviews = top5_reviews)
